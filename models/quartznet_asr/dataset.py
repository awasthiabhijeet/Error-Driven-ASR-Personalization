...
from parts.manifest import Manifest, NeMoManifest
...
class AudioDataset(Dataset):
    def __init__(self, dataset_dir, manifest_filepath, labels, featurizer, max_duration=None, pad_to_max=False,
        ...
        '''
        self.manifest = Manifest(m_paths, labels, blank_index, pad_to_max=pad_to_max,
                             max_duration=max_duration,
                             sort_by_duration=sort_by_duration,
                             min_duration=min_duration, max_utts=max_utts,
                             normalize=normalize, speed_perturbation=speed_perturbation)
        '''
        #replacing Manifest by NeMoManifest (NeMo json format)
        self.manifest = NeMoManifest(dataset_dir, m_paths, labels, blank_index, pad_to_max=pad_to_max,
                             max_duration=max_duration,
                             sort_by_duration=sort_by_duration,
                             min_duration=min_duration, max_utts=max_utts,
                             normalize=normalize, speed_perturbation=speed_perturbation)
